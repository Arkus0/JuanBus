...
const LINEAS = [
  {id:1,nombre:"Obispo Orberá",color:"#8B4513",descripcion:"Recorre el centro histórico",sentidos:[{id:"A",nombre:"Hacia Avenida del Mar 39",paradaFinal:"Avenida del Mar 39",paradas:[7,479,293,273,292,415,414,413,412,79]},{id:"B",nombre:"Hacia Arquímedes",paradaFinal:"Arquímedes",paradas:[506,507,6,406,407,408,409,410,411,440]}]},
  {id:2,nombre:"Hospital Universitario Torrecárdenas",color:"#E63946",descripcion:"De Rambla-Celia Viñas a Hospital",sentidos:[{id:"A",nombre:"Hacia Hospital Universitario Torrecárdenas",paradaFinal:"Hospital Universitario Torrecárdenas",paradas:[32,31,30,29,28,27,392,394,67,403,307,23,426]},{id:"B",nombre:"Hacia Rambla 9",paradaFinal:"Rambla 9",paradas:[420,400,292,401,9,10,11,12,13,391,393,61,396,402,423,19,20,21]}]},
  {id:3,nombre:"Torrecárdenas - Nueva Almería",color:"#2A9D8F",descripcion:"Hospital a zona residencial",sentidos:[{id:"A",nombre:"Hacia Parking Hospital",paradaFinal:"Parking Hospital",paradas:[137,136,163,510,162,455,438,437,447,514,513,494,324,312,395,308,311,307,23,426]},{id:"B",nombre:"Hacia Materno Infantil",paradaFinal:"Materno Infantil",paradas:[151,152,154,511,155,456,432,433,454,417,483,488,388,389,58,81,82,116,126,127,156,161,321,309,306,19,20,21]}]},
  {id:4,nombre:"Torrecárdenas - Universidad",color:"#E9C46A",descripcion:"Conexión universitaria",sentidos:[{id:"A",nombre:"Hacia Universidad",paradaFinal:"Universidad",paradas:[21,20,19,423,402,396,61,60,59,58,389,388,488,483,417,454,433,502,453,452,449,151,150,149,444,147,145,144]},{id:"B",nombre:"Hacia Parking Hospital",paradaFinal:"Parking Hospital",paradas:[426,23,307,403,67,68,291,69,70,71,459,470,513,514,447,437,448,501,450,451,137,138,443,140,141,142,143,144]}]},
  {id:5,nombre:"Centro - Villa Blanca",color:"#F4A261",descripcion:"Zona comercial",sentidos:[{id:"A",nombre:"Hacia Centro Comercial Torrecárdenas",paradaFinal:"Centro Comercial Torrecárdenas",paradas:[32,31,74,72,71,70,69,291,68,67,325,66,65,299,308,487,486,485,484]},{id:"B",nombre:"Hacia Gregorio Marañón 45",paradaFinal:"Gregorio Marañón 45",paradas:[51,52,53,54,55,56,57,58,81,82,116,126,127,156,161,321,309]}]},
  {id:6,nombre:"El Puche - Pescadería",color:"#9B5DE5",descripcion:"Barrios tradicionales",sentidos:[{id:"A",nombre:"Hacia Plaza de Pescadores",paradaFinal:"Plaza de Pescadores",paradas:[84,83,82,81,58,57,56,55,54,53,52,51,50,7,44,79,78,77,76,75]},{id:"B",nombre:"Hacia Polígono La Mezquita",paradaFinal:"Polígono La Mezquita",paradas:[442,96,97,98,99,69,70,71,72,74,31,32,331,4,5,6,101,102,104]}]},
  {id:7,nombre:"Piedras Redondas",color:"#00BBF9",descripcion:"Norte de la ciudad",sentidos:[{id:"A",nombre:"Hacia Árbol de la Seda",paradaFinal:"Árbol de la Seda",paradas:[424,131,286,427,422,421,342,282,117,51,80,7,44,43,108,42,40,39,278,277,158,157,455,438,437,447,434,367]},{id:"B",nombre:"Hacia Araceli-Parque",paradaFinal:"Araceli-Parque",paradas:[128,109,287,111,112,113,114,115,419,420,47,94,48,49,37,274,275,456,432,433,454,417,483,488]}]},
  {id:8,nombre:"Los Molinos - Torrecárdenas",color:"#00F5D4",descripcion:"Zona comercial alternativa",sentidos:[{id:"A",nombre:"Hacia Centro Comercial Torrecárdenas",paradaFinal:"Centro Comercial Torrecárdenas",paradas:[32,31,74,72,71,70,69,291,68,67,325,66,65,299,308,487,486,485,484]},{id:"B",nombre:"Hacia Gregorio Marañón 45",paradaFinal:"Gregorio Marañón 45",paradas:[51,52,53,54,55,56,57,58,81,82,116,126,127,156,161,321,309]}]},
  {id:11,nombre:"Zapillo - Universidad",color:"#F15BB5",descripcion:"Paseo marítimo y universidad",sentidos:[{id:"A",nombre:"Hacia Universidad",paradaFinal:"Universidad",paradas:[32,31,30,29,28,27,392,394,60,59,58,389,388,488,483,417,454,433,432,456,155,154,152,151,150,149,444,147,145,144]},{id:"B",nombre:"Hacia Rambla 9",paradaFinal:"Rambla 9",paradas:[420,47,94,48,49,133,313,134,135,136,137,138,443,140,141,142,143]}]},
  {id:12,nombre:"Nueva Andalucía - Zapillo",color:"#FEE440",descripcion:"Inversa de L11",sentidos:[{id:"A",nombre:"Hacia Universidad",paradaFinal:"Universidad",paradas:[7,44,43,108,42,41,166,314,165,164,152,151,150,149,444,147,145,144]},{id:"B",nombre:"Hacia Rambla 54",paradaFinal:"Rambla 54",paradas:[51,398,399,13,391,393,68,291,69,70,71,459,470,513,514,447,437,438,455,162,510,163,136,137,138,443,140,141,142,143]}]},
  {id:15,nombre:"Circular Levante",color:"#8AC926",descripcion:"Recorrido circular este",sentidos:[{id:"A",nombre:"Hacia Plaza de Costacabana",paradaFinal:"Plaza de Costacabana",paradas:[350,351,431,352,333,457,194,193,192,238,242,244,246,248,252,254,430,258,183,181,180,179,177,144,318,172,171,169]},{id:"B",nombre:"Hacia Residencial Los Girasoles",paradaFinal:"Residencial Los Girasoles",paradas:[221,317,222,316,223,224,225,333,458,268,195,196,239,240,245,247,249,253,255,257,259,204,205,206,207,208,210,144,294,167,168]}]},
  {id:18,nombre:"Torrecárdenas - Costacabana",color:"#FF6B6B",descripcion:"Hospital a playas",sentidos:[{id:"A",nombre:"Hacia Plaza Costacabana",paradaFinal:"Plaza Costacabana",paradas:[320,319,17,16,15,14,13,399,398,114,281,347,341,340,339,338,337,336,298,36,35,331,7,44,43,108,42,41,166,314,165,164,157,151,150,149,444,147,145,144,318,172,171,169]},{id:"B",nombre:"Hacia Parking Hospital",paradaFinal:"Parking Hospital",paradas:[426,23,24,25,26,130,111,112,113,282,342,343,18,344,345,346,1,2,3,328,329,478,420,47,94,48,49,133,313,134,135,136,137,138,443,140,141,142,143,144,294,167,168]}]},
  {id:19,nombre:"Gregorio Marañón - Universidad",color:"#4ECDC4",descripcion:"Ruta universitaria",sentidos:[{id:"A",nombre:"Hacia Residencial Los Girasoles",paradaFinal:"Residencial Los Girasoles",paradas:[32,31,74,72,71,70,389,388,188,474,199,198,197,196,195,268,458,333,225,224,223,316,222,317,221]},{id:"B",nombre:"Hacia Gregorio Marañón 45",paradaFinal:"Gregorio Marañón 45",paradas:[8,292,401,9,54,55,56,57,384,385,188,473,189,190,191,192,193,194,457,333,352,431,351,350]}]},
  {id:20,nombre:"Centro - Hospital El Toyo",color:"#45B7D1",descripcion:"Nuevo hospital",sentidos:[{id:"A",nombre:"Hacia Camino de las Heras",paradaFinal:"Camino de las Heras",paradas:[33,31,30,29,267,99,98,97,96,119,211,210,208,207,206,205,204,259,349,257,255,253,249,247,245,240,239,196,195,268,458,332,265,266,232,231,230,327]},{id:"B",nombre:"Hacia Avenida de la Estación",paradaFinal:"Avenida de la Estación",paradas:[8,401,9,10,11,174,81,82,83,84,175,176,177,179,180,181,183,258,430,252,254,248,246,244,242,238,192,193,194,457,332,264,266,226,227,228,326]}]},
  {id:30,nombre:"Almería - Aeropuerto",color:"#96CEB4",descripcion:"Conexión aeropuerto",sentidos:[{id:"A",nombre:"Hacia Plaza de Costacabana",paradaFinal:"Plaza de Costacabana",paradas:[350,351,431,352,333,457,194,193,192,238,242,244,246,248,252,254,430,258,183,181,180,179,177,176,175,144,318,172,171,169]},{id:"B",nombre:"Hacia Residencial Los Girasoles",paradaFinal:"Residencial Los Girasoles",paradas:[221,317,222,316,224,225,333,458,268,195,196,239,240,245,247,249,253,255,257,259,204,205,206,207,208,210,144,294,167,168]}]},
  {id:31,nombre:"Retamar directo",color:"#FFEAA7",descripcion:"Express a Retamar",sentidos:[{id:"A",nombre:"Hacia Juegos Casablanca-Parque",paradaFinal:"Juegos Casablanca-Parque",paradas:[293,273,472,469,462,460,471,388,465,466,464,463]},{id:"B",nombre:"Hacia Los Girasoles",paradaFinal:"Los Girasoles",paradas:[8,292,468,461,459,470,385,475,214,215,216,302,303,304,355,356]}]}
];
...
// ═══════════════════════════════════════════════════════════════════════════
// FUNCIONES AUXILIARES PARA SENTIDOS
// ═══════════════════════════════════════════════════════════════════════════
 ...
 *
 * @returns {valido: boolean, sentidoId: string|null, sentidoNombre: string|null, numParadas: number}
 */
const validarSentidoRuta = (lineaId, paradaOrigenId, paradaDestinoId) => {
  const linea = LINEAS.find(l => l.id === lineaId);

  // Si la línea no tiene sentidos definidos, aceptar por compatibilidad
  if (!linea || !linea.sentidos) {
    return { valido: true, sentidoId: null, sentidoNombre: null, numParadas: 0 };
  }
  ...
  return { valido: false, sentidoId: null, sentidoNombre: null, numParadas: 0 };
};

/**
 * Obtiene todas las paradas de una línea en un sentido específico
 */
const getParadasEnSentido = (lineaId, sentidoId) => {
  const linea = LINEAS.find(l => l.id === lineaId);
  if (!linea || !linea.sentidos) return [];
  ...
  paradasOrigen.forEach(paradaOrigen => {
    paradasDestino.forEach(paradaDestino => {
      ...
      lineasComunes.forEach(lineaId => {
        // VALIDAR SENTIDO: verificar que ambas paradas estén en el mismo sentido
        // y que el sentido sea de origen a destino (no al revés)
        const validacion = validarSentidoRuta(lineaId, paradaOrigen.id, paradaDestino.id);

        if (!validacion.valido) {
          // Las paradas están en sentido contrario, IGNORAR esta ruta
          return;
        }
        ...
        const detalles = validacion.sentidoNombre
          ? `L${lineaId} ${validacion.sentidoNombre} (${validacion.numParadas} paradas)`
          : `Línea ${lineaId}`;
        ...
        rutas.push({
          ...
          tiempoEstimado,
          detalles,
          sentidoId: validacion.sentidoId,
          sentidoNombre: validacion.sentidoNombre,
          numParadas: validacion.numParadas,
          segmentos: [{
            tipo: 'caminar',
            ...
            sentido: validacion.sentidoNombre
          }, {
            tipo: 'caminar',
  ...
  const LineasView = () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      {LINEAS.map(linea => {
        ...
        // Obtener paradas: si la línea tiene sentidos, contar todas las paradas únicas
        let totalParadas;
        if (linea.sentidos) {
          const paradasUnicas = new Set();
          linea.sentidos.forEach(sentido => sentido.paradas.forEach(pid => paradasUnicas.add(pid)));
          totalParadas = paradasUnicas.size;
        } else {
          totalParadas = PARADAS.filter(p => p.lineas.includes(linea.id)).length;
        }
        ...
        return (
          <div key={linea.id} style={{ background: t.bgCard, borderRadius: 16, overflow: 'hidden', border: `1px solid ${isExp ? linea.color : t.border}` }}>
            ...
            {isExp && (
              <div style={{ padding: '0 20px 16px', borderTop: `1px solid ${t.border}`, paddingTop: 16, maxHeight: 400, overflowY: 'auto' }}>
                {linea.sentidos ? (
                  // Mostrar sentidos separados
                  linea.sentidos.map((sentido, sentidoIdx) => {
                    const paradasSentido = sentido.paradas
                      .map(pid => PARADAS.find(p => p.id === pid))
                      .filter(p => p !== undefined);

                    return (
                      <div key={sentido.id} style={{ marginBottom: sentidoIdx < linea.sentidos.length - 1 ? 24 : 0 }}>
                        <div style={{
                          color: t.text,
                          fontWeight: 600,
                          fontSize: 14,
                          marginBottom: 12,
                          paddingBottom: 8,
                          borderBottom: `2px solid ${linea.color}`,
                          display: 'flex',
                          alignItems: 'center',
                          gap: 8
                        }}>
                  ...
                  // Líneas sin sentidos definidos (comportamiento anterior)
                  PARADAS.filter(p => p.lineas.includes(linea.id)).map((p, i) => (
                    <div
                      key={p.id}
                      onClick={() => setSelectedParada(p)}
                      style={{
